...
public sealed partial class HumanoidProfileEditor
{
    ...
    private void UpdateBarkVoice()
    {
        ...
        _barkPrototypes = _prototypeManager
            ...
            .OrderBy(o => o.Name) //Harvest change: forces the protomanager to consider strings as names to avoid duplicate localization lookup spam
            .ToList();
        ...
        for (var i = 0; i < _barkPrototypes.Count; i++)
        {
            ...
            BarkVoiceButton.AddItem(bark.Name, i); //Harvest change: forces the protomanager to consider strings as names to avoid duplicate localization lookup spam
        }
