...
public abstract class SharedVampireSystem : EntitySystem
{
    ...
    protected void OnBloodsucking(Entity<VampireComponent> ent, ref BloodsuckingSuccessEvent args)
    {
    ...
    protected void OnBloodLeechingAttempt(Entity<VampireComponent> ent, ref BloodLeecherAttemptEvent args)
    {
    ...
    protected void OnAlertClick(Entity<VampireComponent> ent, ref VampireBloodAlertEvent args)
    {
    ...
    protected void OnGlare(Entity<VampireComponent> ent, ref GlareAttemptEvent args)
    {
        args.Cancelled = true;
    }
