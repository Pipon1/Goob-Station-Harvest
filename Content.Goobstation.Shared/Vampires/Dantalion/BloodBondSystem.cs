...
public sealed partial class BloodBondSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (eqe.MoveNext(out var uid, out var bloodLinker, out var vampire))
        {
            ...
            var vampireSystem = EntitySystem.Get<SharedVampireSystem>();
            if (!vampireSystem.HasUsableBlood(vamp, bloodLinker.BloodDrain))
            {
            ...
            vampireSystem.SubtractUsableBlood(vamp, bloodLinker.BloodDrain);
