...
chem-master-output-buffer-draw = Tampon
chem-master-output-beaker-draw = Bécher
chem-master-window-no-beaker-text = Aucun bécher chargé
chem-master-window-beaker-empty-text = Bécher vide
chem-master-window-beaker-low-text = Pas assez de solution dans le bécher
chem-master-output-source = Source d'emballage :
chem-master-no-source = Aucune source
