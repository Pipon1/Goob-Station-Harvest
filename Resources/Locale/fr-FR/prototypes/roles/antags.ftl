...
roles-antag-generic-silicon-antagonist-name = Antagoniste silicium

roles-antag-syndicate-agent-objective = Accomplissez vos objectifs sans vous faire prendre.

roles-antag-syndicate-agent-sleeper-name = Agent dormant du Syndicat
roles-antag-syndicate-agent-sleeper-objective = Une forme de traître pouvant s'activer à n'importe quel moment du shift.
...
roles-antag-nuclear-operative-commander-name = Commandant Opératif nucléaire
roles-antag-nuclear-operative-commander-objective = Menez votre équipe à la destruction de la station.

roles-antag-nuclear-operative-agent-name = Médecin Opératif nucléaire 
roles-antag-nuclear-operative-agent-objective = Comme l'opératif standard, mais le traitement de votre l'équipe aura la priorité.

roles-antag-nuclear-operative-name = Opératif nucléaire
...
roles-antag-space-ninja-name = Ninja de l'espace
...
roles-antag-dragon-name = Dragon de l'espace
