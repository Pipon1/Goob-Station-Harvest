blood-swell-effect-name = Gonflement de Sang
blood-swell-effect-description = Vous subissez moins de dégâts bruts, de brûlures et d'endurance, mais vous ne pouvez pas utiliser d'armes à feu.

blood-rush-effect-name = Ruée Sanglante
blood-rush-effect-description = Votre vitesse de déplacement est doublée.

gladiator-effect-name = Gladiateur
